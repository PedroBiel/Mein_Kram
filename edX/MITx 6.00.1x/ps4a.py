...
def getWordScore(word, n):
    ...
    # Sum of the points for letters in the world.
    points = 0
    score1 = 0
    ...
    score1 = word_len * points
    
    # 50 points if all n letters are used.
    score2 = 0
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    max_value = max(list(hand.values()))
    ...
    while max_value > 0:
        ...
        letters_in_hand = ' '.join(letterslist)
        print('Current hand: ', letters_in_hand)
...
def playGame(wordList):
    ...
    while True:
        ...
        # If hte user inputs 'e', end the game.
        elif x == 'e':
            break
